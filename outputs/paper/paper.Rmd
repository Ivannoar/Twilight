...
Finally, we conduct analysis on the words used in the game themselves. The following table shows the date the word was used, the average score users scored on it, the word of the day, the frequency of the word in texts according to the Corpus of Contemporary American English (COCA), and the number of orthographic neighbors to the word according to MCWord. Orthographic neighbors are defined as words which are the same length but differ by one letter (for example, scare and stare).
